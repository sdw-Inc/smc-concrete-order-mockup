    ...
    'tochigi-factory': {
        '栃木_建築A北': {
            '〇〇ビル新築工事': [
                ...
                { id: '1CX1Y3', status: '打設前検査完了', value: [5.7, 6.12, null, null], unit: ['60N', '30N', '', ''], mixingNo: ['66666', '77777', '', ''], date: 'today', dateColumn: 1, color: 'orange', pouringStatus: 'incomplete', formworkNo: 'No.3', floor: '1F'},
            ...
            '〇〇駅西口再開発': [
                ...
                { id: '3EX1Y4', status: '打設前検査完了', value: [4.1, null, null, null], unit: ['60N', '', '', ''], mixingNo: ['66666', '', '', ''], date: 'today', dateColumn: 1, color: 'orange', pouringStatus: 'incomplete', formworkNo: 'No.4', floor: '3F' },
                ...
                { id: '3EX1Y6', status: '打設前検査完了', value: [4.6, null, null, null], unit: ['60N', '', '', ''], mixingNo: ['66666', '', '', ''], date: 'today', dateColumn: 1, color: 'orange', pouringStatus: 'incomplete', formworkNo: 'No.6', floor: '3F' },
