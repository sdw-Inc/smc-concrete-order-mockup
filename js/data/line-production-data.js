...
const lineProductionData = {
    '栃木_建築A北': {
        '〇〇駅西口再開発': [
            ...
            { id: '1CX1Y5', status: '打設前検査完了', value: [5.8], unit: ['60N'], date: 'tomorrow', color: 'light-yellow' },
    ...
    '栃木_建築B北': {
        '〇〇ビル新築工事': [
            ...
            { id: '2CX1Y5', status: '打設前検査完了', value: [6.4], unit: ['60N'], date: 'tomorrow', color: 'light-yellow' },
